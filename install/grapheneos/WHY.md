...
Maybe there is another explanation. A recommendation appearing after a conversation is not proof that the phone recorded it. But that's almost beside the point. If the only answer available is *trust the operating system vendor*, then you don't actually control that boundary.
